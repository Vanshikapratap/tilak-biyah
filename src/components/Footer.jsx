      ...
      <div className="container footer-content">
        <div className="footer-brand">
          <div className="logo logo-footer cursor-pointer" onClick={() => window.scrollTo(0, 0)} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <img src="/logo.jpg" alt="Tilak byah Logo" className="logo-img-footer" />
            <span style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'red', fontFamily: 'var(--font-heading)' }}>Tilak byah</span>
          </div>
        ...
        <div className="footer-contact">
          ...
          <p>✉️ hello@tilakbyah.com</p>
          <p>📍 Patna, Bihar, India</p>
        </div>
      </div>
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Tilak byah. Celebrating Indian Weddings. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
